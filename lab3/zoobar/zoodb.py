...
# global login_attempts limit
login_attempts_limit = 3
# global login time limit
login_time_limit = 5
...
class Person(PersonBase):
    ...
    last_login_attempt = Column(DateTime, nullable=False, default=datetime.datetime.now)
    picture = Column(String(5000), nullable=False, default="/zoobar/media/default_profile_picture.jpg")
