...
config bank_svc_conf = {bank_svc_cmd, (char*[]){"/banksvc/sock", NULL}, NULL, 61015, 61012, jail, -1, -1};
config *confs[] = {&zookd_conf, &zooksvc_conf, &auth_svc_conf, &bank_svc_conf};
